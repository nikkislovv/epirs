...
const sections = [
  ...
  },
  {
    ...
    text: `Для обработки данных из формы обратной связи мы используем сервис Web3Forms (web3forms.com), серверы которого расположены за пределами Республики Беларусь. Отправляя форму, вы даёте согласие на трансграничную передачу указанных данных этому сервису; передача осуществляется через защищённое соединение. Мы не продаём и не передаём ваши персональные данные третьим лицам в коммерческих целях.\n\nКомпания вправе предоставить данные уполномоченным государственным органам только в случаях и в порядке, предусмотренных законодательством Республики Беларусь.`,
  },
  {
    title: '5. Хранение и защита данных',
    text: `Персональные данные хранятся в течение срока, необходимого для достижения целей, указанных в настоящей Политике, либо до отзыва вашего согласия на обработку. После истечения этого срока данные удаляются.\n\nКомпания принимает необходимые правовые, организационные и технические меры для защиты персональных данных от неправомерного или случайного доступа, изменения, распространения или уничтожения.`,
  },
  {
    title: '6. Ваши права',
    text: `В соответствии с Законом Республики Беларусь «О защите персональных данных» вы имеете право:\n— Получить информацию о том, обрабатываются ли Компанией ваши персональные данные, а также сведения об их обработке;\n— Требовать внесения изменений в свои персональные данные, если они неполны, устарели или неточны;\n— Требовать прекращения обработки персональных данных и (или) их удаления;\n— Отозвать ранее данное согласие на обработку персональных данных в любой момент;\n— Обжаловать действия (бездействие) и решения Компании в Национальный центр защиты персональных данных Республики Беларусь.\n\nДля реализации указанных прав направьте обращение по контактам, указанным ниже. Обращение рассматривается в сроки, установленные законодательством Республики Беларусь.`,
  },
  {
    title: '7. Контакты',
